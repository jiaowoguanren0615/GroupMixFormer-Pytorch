...
def get_args_parser():
    parser = argparse.ArgumentParser(
        'GroupMixFormer training and evaluation script', add_help=False)
    parser.add_argument('--batch-size', default=32, type=int)
    parser.add_argument('--epochs', default=5, type=int)

    # Model parameters
    parser.add_argument('--model', default='groupmixformer_tiny', type=str, metavar='MODEL',
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        'GroupMixFormer training and evaluation script', parents=[get_args_parser()])
