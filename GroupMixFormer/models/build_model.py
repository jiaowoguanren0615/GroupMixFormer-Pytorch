...
class GroupMixFormer(nn.Module):
    def __init__(
            ...
            distillation=False, # seem useless
            **kwargs
    ):
        super().__init__()
...
@register_model
def groupmixformer(pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs):
    EMBEDDING_DIMS = [80, 160, 320, 320]
    SERIAL_DEPTHS = [2, 4, 12, 4]
    MLP_RATIOS = [4, 4, 4, 4]
    DROP_PATH_RATE = 0.2
    model = GroupMixFormer(embedding_dims=EMBEDDING_DIMS,
...
@register_model
def groupmixformer_base(pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs):
...
@register_model
def groupmixformer_large(pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs):
...
@register_model
def groupmixformer_miny(pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs):
...
@register_model
def groupmixformer_small(pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs):
    EMBEDDING_DIMS = [80, 160, 320, 320]
    SERIAL_DEPTHS = [2, 4, 12, 4]
    MLP_RATIOS = [4, 4, 4, 4]
    DROP_PATH_RATE = 0.2
...
@register_model
def groupmixformer_tiny(pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs):
...
#     net = groupmixformer_tiny(num_classes=5)
